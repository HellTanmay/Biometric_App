...
export default function AttendanceScreen() {
  ...
  const [capturepicLoading, setCapturePicLoading] = useState(false);
...
}, [requestCameraPermission, loadAttendanceStatus]);
useEffect(() => {
      ...
      <View style={styles.footer}>
        {loading ? (
          <View style={{ alignItems: "center" }}>
            {capturepicLoading && (
              <Text style={styles.loadingText}>Capturing Picture...</Text>
            )}
                  ...
                  [
                    ...
                    //@ts-ignore
                    {
                      ...
                      onPress: () => {
                        Alert.alert(
                          "Attendance Skipped",
                          "Your attendance has been skipped for today.",
                        );
                      },
                    },
                  ],
